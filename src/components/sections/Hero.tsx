...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none z-[1] bg-gradient-to-b from-[#FCF9F5]/40 via-transparent to-[#FCF9F5]/80" />
      ...
      >
        ...
        <SectionReveal delay={0.2} className="mb-10" style={{ transform: "translateZ(30px)" }}>
          <div className="inline-flex items-center gap-2.5 border border-gold/40 bg-gold/5 text-gold px-5 py-2 rounded-sm text-[10px] font-bold tracking-[0.3em] uppercase backdrop-blur-sm shadow-[0_10px_30px_rgba(212,175,55,0.12)]">
        ...
        <StaggerReveal baseDelay={1.1} stagger={0.1} className="flex flex-wrap justify-center gap-x-12 gap-y-6 pt-10 border-t border-charcoal/5 text-[10px] font-bold uppercase tracking-[0.3em] text-charcoal/40" style={{ transform: "translateZ(10px)" }}>
